...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.26.1/arm-linux',
    archname => 'arm-linux',
    cc => '/home/nopparat/host/bin/arm-buildroot-linux-gnueabihf-gcc',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    dlsrc => 'dl_dlopen.xs',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl5/site_perl/5.26.1/arm-linux',
