 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.26.1/x86_64-linux"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.26.1/x86_64-linux"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.26.1/x86_64-linux"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.26.1/x86_64-linux"		/**/
